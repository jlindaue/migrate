...
void bezier(Vector4d& start_point, Vector4d& end_point){
    ...
    for(int i=0;i<=steps;i++) {
        ...
        x2[i] = (1 - t) * (1 - t) * (1 - t) * (1 - t) * start_point(0) + 
		4 * t * (1 - t) * (1 - t) * (1-t) * P2(0) +
		6 * t * t * (1 - t) * (1 - t) * flex(0) +
		4 * t * t * t * (1-t) * P3(0) +
                    t * t * t * t * end_point(0);
	y2[i] = (1 - t) * (1 - t) * (1 - t) * (1 - t) * start_point(1) + 
                4 * t * (1 - t) * (1 - t) * (1-t) * P2(1) +
                6 * t * t * (1 - t) * (1 - t) * flex(1) +
                4 * t * t * t * (1-t) * P3(1) +
                    t * t * t * t * end_point(1);
